<script>
    var answers = {
        ...
        q2 :"<span>HOW IS THE COST OF THE NECROPSY DETERMINED?</span></br> The total cost of the necropsy depends on the weight of the body, the type of disposal you request, and whether you are eligible and choose to use the local ambulance pickup service. The necropsy calculator below will give you an exact price quote for your particular case. (Note: The body will be weighed upon arrival and the cost will be adjusted if it varies from the weight in the quote).",

        q3: "<span>WHAT DOES A WHOLE BODY NECROPSY INCLUDE?</span></br>All necropsies are performed by our Antech Necropsy Coordinator pathologist, Dr. Richard Moreland, at our Fountain Valley California facility. He has more than 40 years worth of experience in anatomic pathology, specializing in gross necropsy. The necropsy includes a full, detailed, gross examination of all of the tissues, including removal and examination of the brain. Full color digital photographs of important lesions and organs supplement the gross exam and are present in the final report. The exam price includes full histopathology on all of the important tissues. The final report is in full color and is delivered via email. You may see an example necropsy report in the last option below.",
        ...
        q6:"<span>HOW DO WE GET YOU THE BODY?</span></br>Our regular Antech couriers cannot accept full body necropsy submissions under any circumstances.  There are two delivery options: <ol><li>Antech contracts with a private animal ambulance service for body pickup, however the ambulance service only covers a limited area in and around the Los Angeles and San Diego area. The pickup fee is based on the local area code. If you are not within one of these local area codes, the animal ambulance pickup is not available to you.</li><li>We accept shipped bodies that are properly packaged and labeled. See the supplied shipping information and guidelines on the proper packaging and labeling of a body for delivery by the major carriers (USPS, UPS, or FedX.). All shipping fees are between your hospital and the carrier (ANTECH DOES NOT PAY FOR SHIPPING!). Please do not attempt to deliver, have delivered, or ship an animal to us without communicating with us in advance.  You can view detailed shipping instructions at this link <a href='http://www.antechnecropsy.com/shipping_guidelines.pdf' target='_blank'>www.antechnecropsy.com/shipping_guidelines.pdf</li></ol>",
        ...
        q8:"<span>HOW ARE WE BILLED?</span></br>Antech will bill your hospital for the necropsy and any of the ancillary charges (like the ambulance service and the private cremation) on your regular monthly Antech bill. Under no circumstances can we bill or accept payment directly from a pet owner or another third party.",
        ...
        q13:  "<span>CONTACT WITH PET OWNERS</span></br>Under no circumstances can the pathologist have any direct communication (phone calls, email, letters) with the pet owners. The pathologist cannot and will not respond to an owner. All communication and questions must be through the submitting hospital."
